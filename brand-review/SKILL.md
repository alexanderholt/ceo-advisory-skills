...
- **Always safe:** Read files, search code, explore the codebase. No permission needed.
- **Local/reversible (fix mode only):** Edit git-tracked files. Announce, then proceed. If a file is not tracked by git, ask first.
